...
class AlexNet(object):
    ...
    def create(self):
        ...
        conv1, w1 = conv(self.X, 11, 11, 96, 4, 4, padding='VALID', name='conv1')
        ...
        conv2, w2 = conv(pool1, 5, 5, 256, 1, 1, groups=2, name='conv2')
        ...
        conv3, w3 = conv(pool2, 3, 3, 384, 1, 1, name='conv3')
        fm.append(conv3)
        weight.append(w3)

        # 4th Layer: Conv (w ReLu) splitted into two groups
        conv4, w4 = conv(conv3, 3, 3, 384, 1, 1, groups=2, name='conv4')
        fm.append(conv4)
        weight.append(w4)

        # 5th Layer: Conv (w ReLu) -> Pool splitted into two groups
        conv5, w5 = conv(conv4, 3, 3, 256, 1, 1, groups=2, name='conv5')
    ...
    def load_initial_weights(self, session):
        ...
        print("WEIGHTS",weights_dict.keys())
